...
namespace AdventureWorks.Data.FluentAPI.Context
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<Conmasarticulo> Conmasarticulos { get; set; } = null!;
        ...
        public virtual DbSet<Ejercicio1> Ejercicio1s { get; set; } = null!;
        ...
        public virtual DbSet<Productos20> Productos20s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=EN911461\\WORKSHOP;initial catalog=AdventureWorks2019;Integrated Security=True; ");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Conmasarticulo>(entity =>
            {
                entity.ToView("conmasarticulos", "Sales");
            });
            ...
            modelBuilder.Entity<Ejercicio1>(entity =>
            {
                entity.ToView("Ejercicio1");
            });
            ...
            modelBuilder.Entity<Productos20>(entity =>
            {
                entity.ToView("Productos20");
            });
            ...
            {
                entity.ToView("vproductos", "Production");
            });
