...
namespace AdvenutureWorks.Web.MVC.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            var moDbContext = _context.Addresses.Include(a => a.StateProvince);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MoDbContext.Addresses'  is null.");
            }
            var address = await _context.Addresses.FindAsync(id);
            if (address != null)
            {
