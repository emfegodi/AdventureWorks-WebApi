...
namespace AdventureWorks.Ado
{
    ...
    public partial class AdventureWorks2019Entities1 : DbContext
    {
        ...
        [DbFunction("AdventureWorks2019Entities1", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2019Entities1].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
